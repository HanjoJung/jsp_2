	...
	<div class="container-fluid">
		<div class="row" align="center">
			...
			<a href="./memberLogout.jsp"><button class="btn btn-danger" >로그아웃</button></a> <a
				href="./memberUpdate.jsp?id=<%=dto.getId()%>"><button class="btn btn-danger" >수정</button></a>
			<a href="./memberDelete.jsp?id=<%=dto.getId()%>"><button class="btn btn-danger" >탈퇴</button></a>
		</div>
	</div>
</body>
</html>